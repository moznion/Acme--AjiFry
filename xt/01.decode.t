...
$got = Encode::decode_utf8($aji_fry->decode_from_ajifry("食えアジフライお刺身食え食えお刺身ドボドボ岡星ドボドボ"));
is($got, "おさしみ", Encode::encode_utf8("Decode: おさしみ"));

$got = Encode::decode_utf8($aji_fry->decode_from_ajifry("山岡食え食え社主ああドボドボーフライお刺身陶人"));
